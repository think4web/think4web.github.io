...
Ця аптечка нікого не врятує але буде корисна у випадку дрібної травми. Тому її задача не рятувати чи лікувати, а знімати симптоми та незручності. Аптечка повинна бути у маленькій промаркованій сумці щоб її могла знайти у ваших речах випадкова людина, якщо допомогу треба надавати вам та і взагалі усі інструменти у аптечці бажано брати яскравого кольору щоб не загубити, і у швидкому доступі щоб не заляпати усі речі кров'ю, якщо шукаєш аптечку з порізаним пальцем. Кількість ліків залежить від індивідуальної дози і її має вистачати на 1-2 застосування. Рідкі ліки зазвичай продаються у доволі великих банках тому треба знайти для них меншу тару, перелити їх і відповідно позначити пляшечки. Те саме стосується решти ліків - за можливістю треба брати все мініатюрне.

Усі ліки зі списку не є рекомендацією бо список написаний не медиками і різним людям підходять / допомагають різні препарати:
...
- **засіб для дезинфекції** (мінімум 15 мл)
  ...
  - Спирт
  - Хлоргексидин
- **засіб для дрібних ран** - якщо це дрібний поріз чи подряпина буде достатньо створити захистрий шар щоб 
  - рідкий пластир - він майже цілком складається зі спирту, тому краще щоб він був з аналгіном;
  - Клей БФ-6
  - пластир у смужках
  - йод у маркері
  - зеленка у маркері
- **перев'язати рану**
  - **пов'язка на рану стерильна** - для захисту рани від води та бруду;
...
- **краплі для очей** - промити очі від пилу, сміття або комашні, що можуть у них потрапити;
  - Сульфацил натрію 
- **знеболююче** - широкої дії;
- **засіб від температури та симптомів застуди** - порошок з парацетомолом;
...
- **атравматичні ножиці** - розрізати одяг і не порізати себе, відрізати лейкопластир;
